...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020817] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Glow blobs */}
      <div className="absolute top-1/3 right-1/4 w-96 h-96 rounded-full blur-[140px] opacity-12 pointer-events-none"
        style={{ background: 'radial-gradient(circle, #06b6d4, transparent 70%)' }} />
      <div className="absolute bottom-1/4 left-1/4 w-72 h-72 rounded-full blur-[120px] opacity-10 pointer-events-none"
      ...
      <div className="absolute bottom-16 left-16 hidden lg:block pointer-events-none">
        <motion.div
          ...
          className="w-28 h-28 rounded-full border border-cyan-500/10"
        />
        <motion.div
          animate={{ rotate: 360 }}
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm mt-1">Crée ton espace personnel</p>
        </div>

        {/* Card */}
        <div className="bg-white/[0.04] border border-white/10 rounded-3xl p-7 backdrop-blur-sm shadow-[0_0_60px_rgba(0,0,0,0.5)]">
          <h2 className="text-white font-bold text-xl mb-6">Créer un compte</h2>
