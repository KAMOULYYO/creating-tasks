    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#FFF7ED]">
      <div className="w-full max-w-[400px]">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-[14px] mt-1">Tes tâches, organisées avec style</p>
        </div>
        ...
        <div className="bg-white rounded-[28px] border-2 border-orange-200 p-7
          ...
          <h2 className="font-fredoka text-[22px] font-bold text-orange-900 mb-6">Connexion</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            >
              {busy ? <Loader2 size={20} className="animate-spin" /> : <><LogIn size={18} /> Se connecter</>}
            </button>
          </form>
        </div>
